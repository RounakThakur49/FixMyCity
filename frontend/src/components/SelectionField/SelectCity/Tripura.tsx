...
const tripuraCities: readonly string[] = [
    'Agartala',
    'Ambassa',
    'Dharmanagar',
    'Kailasahar',
...
interface TripuraCitySelectProps {
...
export default function TripuraCitySelect({ onCityChange, label }: TripuraCitySelectProps) {
    const [value, setValue] = useState<string | null>(null);

    return (
        <Autocomplete
            id="Tripura-city-select"
            sx={{ width: "100%" }}
            options={tripuraCities}
            autoHighlight
            value={value}
