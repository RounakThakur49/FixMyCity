...
const odishaCities: readonly string[] = [
    'Balasore',
    'Baripada',
    'Berhampur',
    'Bhadrak',
...
interface OdishaCitySelectProps {
...
export default function OdishaCitySelect({ onCityChange, label }: OdishaCitySelectProps) {
    const [value, setValue] = useState<string | null>(null);

    return (
        <Autocomplete
            id="Odisha-city-select"
            sx={{ width: "100%" }}
