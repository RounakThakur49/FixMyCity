...
const chandigarhCities: readonly string[] = [
    'Chandigarh'
];

interface ChandigarhCitySelectProps {
...
export default function ChandigarhCitySelect({ onCityChange, label }: ChandigarhCitySelectProps) {
    const [value, setValue] = useState<string | null>(null);

    return (
        <Autocomplete
            id="chandigarh-city-select"
            sx={{ width: "100%" }}
            options={chandigarhCities}
            autoHighlight
            value={value}
